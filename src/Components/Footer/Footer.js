        ...
        <>
            <Container fluid className="Footer mt-4">
                <Container>
                    <Row>
                        <Col md={3}> 
                                <div> {logo} </div>
                                <p><strong>Contact info</strong> <span style={{fontSize:'14px', color:'rgb(110, 110, 110)'}}>+91 8660462091</span> </p>
            ...
            <Container fluid style={{background:'rgb(218,218,218'}}>
                ...
                <Row className="pt-2 pb-2">
                        <Col md={9} style={{color:'gray', fontSize:'14px', margin:'0%', display:'flex', alignItems:'center'}}> © Shopper Square - Darshan </Col>
                        <Col md={3}>
